    ...
    <>
      ...
      >
        <Navbar className="fluid py-6">
          <FullLogo />
          <MobileDrawer/>
          <NavbarCollapse className="xl:block hidden custom-navbar">
            <DemosMenu />
            <FrontPageMenu/>
            <PagesMenu />
            <NavbarLink as={Link} href="https://demos.adminmart.com/premium/nextjs/modernize-tailwind-nextjs/docs/docs-start.html" className="rounded-md">
              Documentation
            </NavbarLink>
            <NavbarLink as={Link} href="https://adminmart.com/support/" className="rounded-md">
              Support
            </NavbarLink>
            <NavbarLink
              as={Link}
