    ...
    return (
        <CardBox>
         ...
         <Table>
            <TableHead>
              <TableRow>
              <TableHeadCell className="text-sm dark:text-white bg-transparent font-semibold ps-0">
                Assigned
              </TableHeadCell>
              <TableHeadCell className="text-sm dark:text-white bg-transparent font-semibold">
                Progress
              </TableHeadCell>
              <TableHeadCell className="text-sm dark:text-white bg-transparent font-semibold">
                Priority
