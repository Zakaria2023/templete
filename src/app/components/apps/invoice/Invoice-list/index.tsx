  ...
  return (
    <div className="overflow-x-auto">
      ...
      <div className="overflow-x-auto">
        <Table hoverable>
          <TableHead>
            <TableRow className="bg-transparent dark:bg-transparent hover:bg-transparent dark:hover:!bg-transparent" >
                    ...
                    <div className="flex justify-center gap-3">
                      ...
                      <Tooltip content="View Invoice" placement="bottom">
                        <Button
                          ...
                          className="btn-circle p-0 mb-2 !bg-lightprimary !text-primary hover:bg-primary hover:text-white"
                        >
                          <Link
                      ...
                      <Tooltip content="Delete Invoice" placement="bottom">
                        <Button
                          className="btn-circle p-0 mb-2 !bg-lighterror !text-error hover:bg-error hover:text-white"
                          onClick={() => {
